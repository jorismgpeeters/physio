...
public class LegacyGUI extends javax.swing.JFrame {
     ...
     */
    public LegacyGUI() throws DataException {
        initComponents();
    ...
    public static void main(String args[]){
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LegacyGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
